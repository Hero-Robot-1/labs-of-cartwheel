const collectionsData = {
  ...
  ethereumGoerli: {
    contractAddress: "0xc0dcf71fdd81457c439b3f2669ab6945f2074e3e",
    abi: "safeMint(toAddress address, tokenUri string)",
  },
  polygonMumbai: {
  ...
  avalancheFujiCChain: {
    contractAddress: "0xd2138a8a2a3ce433ce2a1dc06a5b5a19d5680d83",
    abi: "safeMint(toAddress address, tokenUri string)",
  },
  avalancheCChain: {
  ...
  tezosGhost: {
    contractAddress: "KT1HPWEgkKawxjnq8L6569THCTG3DGD8XziL",
    abi: "{}",
  },
  polygon: {
  ...
  arbitrumGoerli: {
    contractAddress: "0x1bcb8607090dab9b584cf86bf55880cb0a0cedc3",
    abi: "safeMint(toAddress address, tokenUri string)",
  },
  arbitrum: {
